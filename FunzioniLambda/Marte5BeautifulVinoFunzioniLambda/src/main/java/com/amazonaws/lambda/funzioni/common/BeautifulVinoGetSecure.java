...
public class BeautifulVinoGetSecure implements RequestHandler<RichiestaGetGenerica, RispostaGetGenerica> {
	...
	private final static String FUNCTION_NAME_GET_PROFILOAZIENDA = "getProfiloAziendaGen";
	private final static String FUNCTION_NAME_GET_VINIAZIENDA = "getViniAziendaGen";
	private final static String FUNCTION_NAME_GET_UTENTIAZIENDA = "getUtentiAziendaGen";
	private final static String FUNCTION_NAME_GET_EVENTIAZIENDA = "getEventiAziendaGen";
	private final static String FUNCTION_NAME_GET_FEEDAZIENDA = "getFeedAziendaGen";
	private final static String FUNCTION_NAME_GET_UTENTEMAIL = "getUtenteEmailGen";
    ...
    public RispostaGetGenerica handleRequest(RichiestaGetGenerica input, Context context) {
        ...
        if(!isFunctionNameValid(functionName)) {
			...
			esito.setMessage(EsitoHelper.ESITO_KO_MESSAGGIO_ERRORE_GET + " la funzione " + functionName + " richiesta non esiste ");
    ...
    private boolean isFunctionNameValid(String nomeFunzione) {
    		...
    		funzioni.add(FUNCTION_NAME_GET_PROFILOAZIENDA);
    		funzioni.add(FUNCTION_NAME_GET_VINIAZIENDA);
    		funzioni.add(FUNCTION_NAME_GET_UTENTIAZIENDA);
