    ...
    private RispostaConnectEventoAUtente getRisposta(RichiestaConnectEventoAUtente input) {
        ...
        AmazonDynamoDB client = null;
    		...
    		if(client != null) {
    			...
    			if(statoEvento == null || statoEvento.equals("") || (!statoEvento.equals(FunzioniUtils.EVENTO_STATO_PREFERITO) && !statoEvento.equals(FunzioniUtils.EVENTO_STATO_ACQUISTATO) && !statoEvento.equals(FunzioniUtils.EVENTO_STATO_CANCELLATO))) {
    				esito.setCodice(EsitoHelper.ESITO_KO_CODICE_ERRORE_GET);
    			...
    			//CONTROLLO COMMENTATO PER ORA PERCHè NECESSARIA ANCHE LA CHIAVE SECONDARIA
//    			Evento evento = mapper.load(Evento.class, idEvento);
//    			if(evento == null) {
//    				esito.setCodice(EsitoHelper.ESITO_KO_CODICE_ERRORE_GET);
//    		        esito.setMessage(EsitoHelper.ESITO_KO_MESSAGGIO_ERRORE_GET + " evento non trovato sul DB, non posso procedere");
//    		        risposta.setEsito(esito);
//    		        return risposta;
//    			}
    			...
    			if(eventoGiaAssociato) {
    				...
    				if(daRimuovere.getStatoEvento().equals(FunzioniUtils.EVENTO_STATO_ACQUISTATO)) {
        				...
        				if(!statoEvento.equals(FunzioniUtils.EVENTO_STATO_CANCELLATO)) {
